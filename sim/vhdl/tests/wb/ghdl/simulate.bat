...
ghdl -a --std=08 ../../../../../bench/vhdl/tests/pu/wb/riscv_memory_model_wb.vhd
ghdl -a --std=08 ../../../../../bench/vhdl/tests/pu/wb/riscv_mmio_if_wb.vhd
ghdl -a --std=08 ../../../../../bench/vhdl/tests/pu/wb/riscv_testbench_wb.vhd
